...
export default function Sidebar({
    ...
    const latestOutCount = data.reduce(
        (acc, r) =>
            rangeSeverity(r.value, r.reference_range) === "in" ? acc : acc + 1,
        0
    );
    return (
        <aside
            className="w-56 shrink-0 pr-4 border-r border-slate-200 sticky top-0 self-start"
