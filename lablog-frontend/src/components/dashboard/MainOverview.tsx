...
export default function MainOverview({
    ...
    const outRows: AggRow[] = useMemo(() => {
        const latest: Record<string, DashboardRow> = {};
        data.forEach((r) => {
            const k = r.test_name;
            const t = new Date(
        ...
        <div className="text-sm text-gray-700 space-y-8">
                    ...
                    <div className="border rounded-lg bg-white shadow-sm ring-1 ring-slate-100 overflow-hidden">
                        <table className="w-full text-[12px] border-collapse">
                            ...
                            <tbody>
                                {outRows.map((r, i) => {
                                    const displayName =
                                        r.test_name.length > 26
                                            ? r.test_name.slice(0, 23) + "…"
                                            : r.test_name;
                                    return (
                                        <tr
                                            key={i}
                                        ...
                                        >
                                            <td
                                                className="px-2 py-1 border-b font-medium"
                                                title={r.test_name}
                                            >
                                                {displayName}
                                            </td>
            ...
            <section>
                ...
                <form
                    ...
                    aria-label="Add new scheduled test form"
                >
                                                ...
                                                >
                                                    <button
                                                        ...
                                                        aria-label={
                                                                ...
                                                                ? `Mark ${t.test_name} pending`
                                                                : `Mark ${t.test_name} done`
                                                        }
                                                        onClick={() =>
                                                            markScheduleComplete(
                                                                t.test_name
                                                    ...
                                                    <span
                                                        className="text-[10px] uppercase tracking-wide rounded px-1 py-0.5 bg-blue-50 text-blue-700 border border-blue-200"
                                                        title={
                                                            t.doctor
                                                                ? `Issue here, see ${t.doctor}`
                                                                : undefined
                                                        }
                                                    >
                                                        {t.reason}
                                                        {t.doctor && (
                                                            <span className="ml-1 normal-case font-normal text-[9px] text-slate-600">
                                                                see {t.doctor}
                                                            </span>
                                                        )}
                                                    </span>
                                                    <button
                                                        type="button"
                                                        aria-label={`Remove ${t.test_name} from schedule`}
                                                        onClick={() =>
                                                            removeSchedule(
                                                                t.test_name
                                                            )
